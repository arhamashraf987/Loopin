...
class AuthScreen extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            authOptionContainer("Continue with phone number", Icons.call_outlined, (){Get.toNamed(AppRoutes.phoneVerify);}),
            SizedBox(height: 20.h,),
            authOptionContainer("Sign up with email", Icons.email_outlined, (){Get.toNamed(AppRoutes.signup);}),
            SizedBox(height: 20.h,),
  ...
  Widget authOptionContainer(String label, IconData iconName, VoidCallback onTap) 
   {
